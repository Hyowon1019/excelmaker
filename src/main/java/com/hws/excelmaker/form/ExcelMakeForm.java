...
public class ExcelMakeForm {
    ...
    public ExcelMakeForm() {}

    public ExcelMakeForm(String contractDate, String customerName, String belong, String carName, Integer carPrice, String releaseStore, Double charge, String progress, Integer cashBack, String releasePlace, String supportContents, String etcContents, String enrollDate, String carNumber) {
